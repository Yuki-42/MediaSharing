...
class EndpointLoggerAdapter(SuppressedLoggerAdapter):
    """
    Used for logging access to the endpoints separately from the rest of the logs.
    """
    ...
    def logRequest(self, request: Request):
        ...
        """
        # TODO: Make this a worker queue to prevent blocking the main thread
        self.logger.info(
...
def createLogger(
    ...
    return adapter(logger, {"loggername": name})
